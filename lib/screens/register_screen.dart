...
String formatDate(String date) {
  // Adapte conforme necessário para garantir que a data esteja no formato correto
  final dateParts = date.split('/');
  if (dateParts.length == 3) {
    return '${dateParts[2]}-${dateParts[1]}-${dateParts[0]}';
  }
  return date; // Retorne a data no formato correto se já estiver no formato correto
}
  ...
  void _register() async {
    ...
    'dataNascimento': formatDate(_dataNascimentoController.text),
        },
        'conta': {
